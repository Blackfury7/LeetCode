...
public:
   ...
   double solve(int poured, int row, int glass){
       ...
       // how much comes from left part - first coordinate(i -1, j - 1) then keep 1 for themself
       ...
       // how much comes from right part - first coordinate ( i - 1, j) then keep 1 for themself and 
       // then divide by 2
